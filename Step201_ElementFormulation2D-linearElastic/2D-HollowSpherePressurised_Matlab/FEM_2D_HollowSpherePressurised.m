function FEM_2D_HollowSpherePressurised
...
addpath("/calculate/iwtm41_lokal/AceGen/3_Q1X_2Dax_linElastic")
...
element_type = "Q1X_2Dax"; % standard_Bower, hybrid_Bower, Q1X_2Dax
...
%
 ...
 for i =1:nnode
   ...
   x2=coords(2,i);
   r=sqrt(x1^2+x2^2);
   ur = 1/(2*E*(b^3-a^3)*r^2) * ( 2*(p*a^3-0)*(1-2*nu)*r^3+(p-0)*(1+nu)*b^3*a^3 );
...
%             NQP = 1; HG_active = 1;
            ...
            cm = zeros([100,1]);
            cm(1:16) =  [ 0, 0,        NQP,        HG_active, 0, 0, 0, 0, ...
            ...
            [~,kel,~] = Q1X_2Dax_linElastic(X,pe,cm,hsve,nhsv,ndtot,istif,ele);
